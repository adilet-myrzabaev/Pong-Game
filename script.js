...
let rounds = [5,5,5,3,3,3,2,2,2,1];
let colors = ['#1abc9c', '#2ecc71', '#3498db', '#8c52ff', '#9b59b6', '#2ecc71','#1abc9c', '#8c52ff'];
...
let Game = {
    ...
    menu: function () {
        ...
        this.context.fillText('Нажмите любую клавишу чтобы начать',
            this.canvas.width / 2,
    ...
    update: function () {
        if (!this.over) {
            ...
            if (this.ball.x - this.ball.width <= this.player.x
        ...
        if (this.player.score === rounds[this.round]) {
            if (!rounds[this.round + 1]) {
                this.over = true;
                setTimeout(function () { Pong.endGameMenu('Победа!'); }, 1000);
            } else {
            ...
            this.over = true;
            setTimeout(function() {Pong.endGameMenu('Вы проиграли!'); }, 1000);
        }
    },
